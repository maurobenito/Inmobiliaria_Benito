        ...
        private int ObtenerUsuarioLogueadoId()
{
        ...
        public IActionResult Details(int id)
        {
           var contrato = _context.Contratos
            ...
            .Include(c => c.UsuarioFinalizacion)
    ...
    if (ocupado)
    {
        ...
        // Opcional: solo si estás acortando el contrato
        if (contrato.FechaHasta < _context.Contratos.AsNoTracking().First(c => c.ContratoId == contrato.ContratoId).FechaHasta)
        {
