...
public IActionResult Create()
{
    ...
    {
        Inmueble = new Inmueble(), // Para evitar NullReferenceException
        Propietarios = _context.Propietarios
            .Select(p => new SelectListItem
            {
                Value = p.PropietarioId.ToString(),
                Text = p.Nombre + " " + p.Apellido
            }),
        TiposInmueble = _context.TipoInmuebles
    ...
    return View(model); // <- Pasa el ViewModel
}
