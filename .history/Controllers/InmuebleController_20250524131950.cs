 ...
 public IActionResult Disponibles()
{
    ...
    var contratosVigentes = _context.Contratos
        ...
        .Select(c => c.IdInmueble) // supongo que tienes esta FK
        .ToList();

    // Obtener inmuebles que NO tienen contrato vigente
    var inmueblesDisponibles = _context.Inmuebles
        .Where(i => !contratosVigentes.Contains(i.InmuebleId)) // Filtrar inmuebles sin contrato vigente
        .ToList();
