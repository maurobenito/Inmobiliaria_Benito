    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Contrato>(entity =>
        {
            ...
            entity.HasOne(d => d.IdInquilinoNavigation).WithMany(p => p.Contratos)
                ...
                entity.HasIndex(e => e.UsuarioCreacionId, "usuario_creacion_id");
entity.HasIndex(e => e.UsuarioRescisionId, "usuario_rescision_id");

entity.Property(e => e.UsuarioCreacionId)
    .HasColumnType("int(11)")
    .HasColumnName("usuario_creacion_id");

entity.Property(e => e.UsuarioRescisionId)
    .HasColumnType("int(11)")
    .HasColumnName("usuario_rescision_id");

entity.HasOne(d => d.UsuarioCreacion)
    .WithMany()
    .HasForeignKey(d => d.UsuarioCreacionId)
    .HasConstraintName("contrato_ibfk_usuario_creacion");

entity.HasOne(d => d.UsuarioRescision)
    .WithMany()
    .HasForeignKey(d => d.UsuarioRescisionId)
    .HasConstraintName("contrato_ibfk_usuario_rescision");
